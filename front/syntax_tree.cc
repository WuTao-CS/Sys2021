...
void TreeNodeBlock::accept(syntax_tree_visitor &visitor)
{
    visitor.visit(*this);
}
...
void TreeNodeLVal::accept(syntax_tree_visitor &visitor)
{
    visitor.visit(*this);
}
...
void TreeNodeEqExp::accept(syntax_tree_visitor &visitor)
{
    visitor.visit(*this);
}
