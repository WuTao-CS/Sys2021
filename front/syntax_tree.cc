...
void syntax_tree::run_visitor(Tree_visitor &visitor)
{
    root->accept(visitor);
}
void TreeNodeDeclDef::accept(Tree_visitor &visitor)
{
#ifdef MY_DEBUG
...
void TreeNodeBlockItem::accept(Tree_visitor &visitor)
{
#ifdef MY_DEBUG
...
void TreeNodeStmt::accept(Tree_visitor &visitor)
{
#ifdef MY_DEBUG
...
void TreeNodeExp::accept(Tree_visitor &visitor)
{
#ifdef MY_DEBUG
...
void TreeNodeCond::accept(Tree_visitor &visitor)
{
#ifdef MY_DEBUG
...
void TreeNodePrimaryExp::accept(Tree_visitor &visitor)
{
    visitor.visit(*this);
}
void TreeNodeConstExp::accept(Tree_visitor &visitor)
{
    visitor.visit(*this);
}
void TreeNodeCompUnit::accept(Tree_visitor &visitor)
{
    visitor.visit(*this);
}
void TreeNodeConstDecl::accept(Tree_visitor &visitor)
{
    visitor.visit(*this);
}
void TreeNodeConstDef::accept(Tree_visitor &visitor)
{
    visitor.visit(*this);
}
void TreeNodeConstInitVal::accept(Tree_visitor &visitor)
{
    visitor.visit(*this);
}
void TreeNodeVarDecl::accept(Tree_visitor &visitor)
{
    visitor.visit(*this);
}
void TreeNodeVarDef::accept(Tree_visitor &visitor)
{
    visitor.visit(*this);
}
void TreeNodeInitVal::accept(Tree_visitor &visitor)
{
    visitor.visit(*this);
}
void TreeNodeFuncDef::accept(Tree_visitor &visitor)
{
    visitor.visit(*this);
}
void TreeNodeFuncFParam::accept(Tree_visitor &visitor)
{
    visitor.visit(*this);
}
void TreeNodeBlock::accept(Tree_visitor &visitor)
{
    visitor.visit(*this);
}
void TreeNodeBreakStmt::accept(Tree_visitor &visitor)
{
    visitor.visit(*this);
}
void TreeNodeContinueStmt::accept(Tree_visitor &visitor)
{
    visitor.visit(*this);
}
void TreeNodeAssignStmt::accept(Tree_visitor &visitor)
{
    visitor.visit(*this);
}
void TreeNodeSelectStmt::accept(Tree_visitor &visitor)
{
    visitor.visit(*this);
}
void TreeNodeIterationStmt::accept(Tree_visitor &visitor)
{
    visitor.visit(*this);
}
void TreeNodeReturnStmt::accept(Tree_visitor &visitor)
{
    visitor.visit(*this);
}
void TreeNodeLVal::accept(Tree_visitor &visitor)
{
    visitor.visit(*this);
}
void TreeNodeNumber::accept(Tree_visitor &visitor)
{
    visitor.visit(*this);
}
void TreeNodeUnaryExp::accept(Tree_visitor &visitor)
{
    visitor.visit(*this);
}
void TreeNodeCallee::accept(Tree_visitor &visitor)
{
    visitor.visit(*this);
}
void TreeNodeMulExp::accept(Tree_visitor &visitor)
{
    visitor.visit(*this);
}
void TreeNodeAddExp::accept(Tree_visitor &visitor)
{
    visitor.visit(*this);
}
void TreeNodeRelExp::accept(Tree_visitor &visitor)
{
    visitor.visit(*this);
}
void TreeNodeEqExp::accept(Tree_visitor &visitor)
{
    visitor.visit(*this);
}
void TreeNodeLAndExp::accept(Tree_visitor &visitor)
{
    visitor.visit(*this);
}
void TreeNodeLOrExp::accept(Tree_visitor &visitor)
{
    visitor.visit(*this);
}
