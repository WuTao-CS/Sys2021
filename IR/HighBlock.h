...
class IfBlock : public BaseBlock
{
  public:
    ...
    std::list<BaseBlock *> &getCondBBs()
    {
        return cond_;
    }
    std::list<BaseBlock *> &getIfBodyBBs()
    {
        return if_body_;
    }
    std::list<BaseBlock *> &getElseBodyBBs()
    {
        return else_body_;
    }

    void removeCondBB(BaseBlock *bb)
    {
        cond_.remove(bb);
    }
    void removeIfBodyBB(BaseBlock *bb)
    {
        if_body_.remove(bb);
    }
    void removeElseBodyBB(BaseBlock *bb)
    {
        else_body_.remove(bb);
    }
...
class WhileBlock : public BaseBlock
{
  public:
    ...
    void removeWhileBodyBB(BaseBlock *bb)
    {
        body_.remove(bb);
    }
    void removeBB(BaseBlock *bb)
