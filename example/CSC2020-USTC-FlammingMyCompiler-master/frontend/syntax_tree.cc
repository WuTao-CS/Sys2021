...
// void SyntaxCompUnit::accept(syntax_tree_visitor &visitor) {visitor.visit(*this);}
...
// void SyntaxConstDecl::accept(syntax_tree_visitor &visitor) {visitor.visit(*this);}
// void SyntaxConstDef::accept(syntax_tree_visitor &visitor) {visitor.visit(*this);}
// void SyntaxConstInitVal::accept(syntax_tree_visitor &visitor) {visitor.visit(*this);}
// void SyntaxVarDecl::accept(syntax_tree_visitor &visitor) {visitor.visit(*this);}
// void SyntaxVarDef::accept(syntax_tree_visitor &visitor) {visitor.vist(*this);}
// void SyntaxInitVal::accept(syntax_tree_visitor &visitor) {visitor.visit(*this);}
// void SyntaxFuncDef::accept(syntax_tree_visitor &visitor) {visitor.visit(*this);}
// void SyntaxFuncFParam::accept(syntax_tree_visitor &visitor) {visitor.visit(*this);}
...
// void SyntaxBreakStmt::accept(syntax_tree_visitor &visitor) {visitor.visit(*this);}
// void SyntaxContinueStmt::accept(syntax_tree_visitor &visitor) {visitor.visit(*this);}
// void SyntaxAssignStmt::accept(syntax_tree_visitor &visitor) {visitor.visit(*this);}
// void SyntaxSelectStmt::accept(syntax_tree_visitor &visitor){visitor.visit(*this);}
// void SyntaxIterationStmt::accept(syntax_tree_visitor &visitor){visitor.visit(*this);}
// void SyntaxReturnStmt::accept(syntax_tree_visitor &visitor){visitor.visit(*this);}
...
// void SyntaxNumber::accept(syntax_tree_visitor &visitor){visitor.visit(*this);}
// void SyntaxUnaryExp::accept(syntax_tree_visitor &visitor){visitor.visit(*this);}
// void SyntaxCallee::accept(syntax_tree_visitor &visitor){visitor.visit(*this);}
// void SyntaxMulExp::accept(syntax_tree_visitor &visitor){visitor.visit(*this);}
// void SyntaxAddExp::accept(syntax_tree_visitor &visitor){visitor.visit(*this);}
// void SyntaxRelExp::accept(syntax_tree_visitor &visitor){visitor.visit(*this);}
// void SyntaxEqExp::accept(syntax_tree_visitor &visitor){visitor.visit(*this);}
// void SyntaxLAndExp::accept(syntax_tree_visitor &visitor){visitor.visit(*this);}
// void SyntaxLOrExp::accept(syntax_tree_visitor &visitor){visitor.visit(*this);}
...
void SyntaxConstInitVal::accept(syntax_tree_visitor &visitor) {visitor.visit(*this);}
void SyntaxVarDecl::accept(syntax_tree_visitor &visitor) {visitor.visit(*this);}
void SyntaxVarDef::accept(syntax_tree_visitor &visitor) {visitor.visit(*this);}
void SyntaxInitVal::accept(syntax_tree_visitor &visitor) {visitor.visit(*this);}
void SyntaxFuncDef::accept(syntax_tree_visitor &visitor) {visitor.visit(*this);}
void SyntaxFuncFParam::accept(syntax_tree_visitor &visitor) {visitor.visit(*this);}
void SyntaxBlock::accept(syntax_tree_visitor &visitor) {visitor.visit(*this);}
