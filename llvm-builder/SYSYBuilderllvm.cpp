...
llvm::Constant* ToConstArray(std::vector<int32_t> &array_bounds,std::vector<llvm::Value*> &array_init, llvm::Type* TyInt32){
...
void SYSYCBuilder::visit(TreeNodeCompUnit &node) {
...
void SYSYCBuilder::visit(TreeNodeConstDecl &node) {
...
void SYSYCBuilder::visit(TreeNodeConstDef &node) {
  ...
  if (node.ArrayConstExpList.size() == 0) {
    ...
    //   if(node.ConstInitVal!=nullptr){//assign
    //     node.ConstInitVal->accept(*this);
...
void SYSYCBuilder::visit(TreeNodeConstInitVal &node) {
...
void SYSYCBuilder::visit(TreeNodeConstExp &node) {
...
void SYSYCBuilder::visit(TreeNodeVarDecl &node) {
...
void SYSYCBuilder::visit(TreeNodeVarDef &node) {
...
void SYSYCBuilder::visit(TreeNodeInitVal &node) {
...
void SYSYCBuilder::visit(TreeNodeFuncDef &node) {
...
void SYSYCBuilder::visit(TreeNodeFuncFParam &node) {node.ParamArrayExpList;}

void SYSYCBuilder::visit(TreeNodeBlock &node) {
...
void SYSYCBuilder::visit(TreeNodeBreakStmt &node) {
...
void SYSYCBuilder::visit(TreeNodeContinueStmt &node) {
...
void SYSYCBuilder::visit(TreeNodeAssignStmt &node) {
...
void SYSYCBuilder::visit(TreeNodeSelectStmt &node) {
...
void SYSYCBuilder::visit(TreeNodeIterationStmt &node) {
...
void SYSYCBuilder::visit(TreeNodeReturnStmt &node) {
...
void SYSYCBuilder::visit(TreeNodeLVal &node) {
...
void SYSYCBuilder::visit(TreeNodePrimaryExp &node) {
...
void SYSYCBuilder::visit(TreeNodeNumber &node) {
...
void SYSYCBuilder::visit(TreeNodeUnaryExp &node) {
...
void SYSYCBuilder::visit(TreeNodeCallee &node) {
...
void SYSYCBuilder::visit(TreeNodeMulExp &node) {
...
void SYSYCBuilder::visit(TreeNodeAddExp &node) {  
...
void SYSYCBuilder::visit(TreeNodeRelExp &node) {
...
void SYSYCBuilder::visit(TreeNodeEqExp &node) {
...
void SYSYCBuilder::visit(TreeNodeLAndExp &node) {
...
void SYSYCBuilder::visit(TreeNodeLOrExp &node) {
